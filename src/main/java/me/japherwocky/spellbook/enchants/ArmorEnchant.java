...
public class ArmorEnchant implements SpellbookEnchant {

    public static final Key KEY = Key.key("spellbook:armor");
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("spellbook.enchant.armor", "Armor");
    }
    ...
    public @NotNull TagKey<ItemType> getTagForSupportedItems() {
        return TagKey.create(RegistryKey.ITEM, Key.key("spellbook:armor_enchantable"));
    }
    ...
    public static ArmorEnchant create(ConfigurationSection configurationSection) {
        ArmorEnchant armorEnchant = new ArmorEnchant(
                ...
                SpellbookConfig.getDouble(configurationSection, "armorPerLevel", 1.0)
        );

        if (SpellbookConfig.getBoolean(configurationSection, "enabled", true)) {
            ENCHANTS.put(armorEnchant.getKey(), armorEnchant);
        }
