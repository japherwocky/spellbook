...
public class MagicMissileEnchant implements SpellbookEnchant {

    public static final Key KEY = Key.key("spellbook:magic_missile");
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("spellbook.enchant.magic_missile", "Magic Missile");
    }
    ...
    public static MagicMissileEnchant create(ConfigurationSection configurationSection) {
        MagicMissileEnchant magicMissileEnchant = new MagicMissileEnchant(
                ...
                EnchantmentRegistryEntry.EnchantmentCost.of(
                        ...
                        SpellbookConfig.getInt(configurationSection, "minimumCost.additionalPerLevel", 10)
                ),
                EnchantmentRegistryEntry.EnchantmentCost.of(
                        SpellbookConfig.getInt(configurationSection, "maximumCost.base", 65),
                        SpellbookConfig.getInt(configurationSection, "maximumCost.additionalPerLevel", 10)
                ),
