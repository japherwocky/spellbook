...
public class ReplantingEnchant implements SpellbookEnchant {

    public static final Key KEY = Key.key("spellbook:replanting");
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("spellbook.enchant.replanting", "Replanting");
    }
