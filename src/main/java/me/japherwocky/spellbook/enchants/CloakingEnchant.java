...
public class CloakingEnchant implements SpellbookEnchant {

    public static final Key KEY = Key.key("spellbook:cloaking");
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("spellbook.enchant.cloaking", "Cloaking");
    }
    ...
    public static CloakingEnchant create(ConfigurationSection configurationSection) {
        CloakingEnchant cloakingEnchant = new CloakingEnchant(
                ...
                EnchantmentRegistryEntry.EnchantmentCost.of(
                        SpellbookConfig.getInt(configurationSection, "minimumCost.base", 25),
